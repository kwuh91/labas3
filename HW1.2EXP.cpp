...
void reform_with_deletion(char **a, int n) {
    ...
    for (size_t i = 0; i < 100; ++i) {
        if (i != n) {
            ...
            //std::cout << "i = " << i << " n = " << n << " ind = " << ind << " string: " << *(a+i) << std::endl;
            ++ind;
        }
    }
    ...
    for (size_t i = 0; i < 100; ++i) {
        for (size_t j = 0; j < 100; ++j) {
            *(*(a + i) + j) = *(*(temp_arr + i) + j);
            //std::cout << "i = " << i << " j = " << j << " string: " << *(a+i) << std::endl;
        }
    }
    ...
    while (true) {
        ...
        switch (option) {
            case 0: {
                ...
                //reforming(arr_of_strings, n);
                //std::cout << arr_of_strings + n - 1 << ' ' << *(arr_of_strings + n - 1) << std::endl;
                std::cin >> *(arr_of_strings + n - 1); //HERE
                    ...
                    case 1: {
                        ...
                        if (!flag0) {
                            ...
                            for (size_t i = 0; i < strlen(*(arr_of_strings + string_choice - 1)); ++i) {
                                //*(concatenated_string+i) = *(*(arr_of_strings+string_choice-1)+i);
                                //TODO strncat
                                strncat(concatenated_string, &*(*(arr_of_strings + string_choice - 1) + i), 1);
                            }
                            //std::cout << "RESULT1: " << concatenated_string << std::endl;
                            for (size_t i = 0; i < strlen(*(arr_of_strings + n - 1)); ++i) {
                                //*(concatenated_string+i) = *(*(arr_of_strings+n-1)+i);
                                //TODO strncat
                                strncat(concatenated_string, &*(*(arr_of_strings + n - 1) + i), 1);
                            }

                            //std::cout << "RESULT2: " << concatenated_string << std::endl;
                            ++n;
                            //reforming(arr_of_strings, n);
                            //TODO strcpy
                            //string_copy(*(arr_of_strings+n-1),concatenated_string);
            ...
            case 3: {
                ...
                if (!flag0) {
                    ...
                    if (string_dest == 0) {
                        ...
                        //string_copy(*(arr_of_strings+n-1),*(arr_of_strings+string_choice-1));
                        std::cout << "String " << *(arr_of_strings + string_choice - 1)
                                  << " was copied to a new slot and added to your strings\n";
                    } else {
                        //TODO strcpy
                        strcpy(*(arr_of_strings + string_dest - 1), *(arr_of_strings + string_choice - 1));
                        //string_copy(*(arr_of_strings+string_dest-1),*(arr_of_strings+string_choice-1));
